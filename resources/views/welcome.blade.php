...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'MudTech') }}</title>
        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            >
                                <div id="screenshot-container-1" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        ...
                                        alt="Servers image"
                                        class="aspect-video h-full w-full rounded-[10px] object-cover drop-shadow-sm"
                                    />
                                </div>
                    ...
                    <footer class="mt-12 border-t border-gray-200 dark:border-gray-700 py-8 text-center text-sm text-black dark:text-white/70">
                        <div class="mb-2">
                            © {{ now()->year }} MudTech. All rights reserved.
                        </div>
                        <div class="mb-2">
