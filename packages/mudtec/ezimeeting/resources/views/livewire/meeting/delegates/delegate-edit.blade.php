        ...
        <div class="container mx-auto bg-white shadow-md rounded-lg p-6 w-6/7">
            ...
            <div class="flex justify-end mt-2"> 
                <button 
                    ...
                    class="bg-blue-500 text-white rounded-full h-10 w-10 flex items-center justify-center hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                >
                    +
                </button>
            </div>    
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 space-y-4">
                    <div class="grid grid-cols-1 lx:grid-cols-2 gap-2">
