<div class="flex flex-col items-center justify-center py-16 bg-gray-200">
    <div class="container mx-auto px-4">
        ...
        <div wire:poll.10s class="container mx-auto py-8">
                        ...
                        <tr class="bg-gray-300 text-gray-600 uppercase text-sm leading-normal">
                            <th class="py-3 px-6 text-left">
                                <a href="#" wire:click.prevent="sortBy('name')">
                                    Name
                                    @if ($sortDirection === 'asc' and $sortField == "name")
                                        🔼
                                    @else
                                        🔽
                                    @endif
                            ...
                            <th class="py-3 px-6 text-left">
                                <a href="#" wire:click.prevent="sortBy('email')">
                                    Email
                                    @if ($sortDirection === 'asc' and $sortField == "email")
                                        🔼
                                    @else
                                        🔽
                                    @endif
                            ...
                            <tr class="border-b border-gray-200 bg-gray-100 hover:bg-gray-200 hover:border-gray-300">
                                ...
                                <td class="py-3 px-6 text-left items-center justify-between space-x-2">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('corpUserEdit',['user'=>$user->id]) }}" class="text-sm text-teal-500 font-semibold rounded hover:text-teal-800">
                                        ...
                                        <button wire:click="corpDeleteUser({{ $user->id }})" class="text-sm text-red-500 font-semibold rounded hover:text-teal-800 mr-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="w-8 h-8">
                                                <path stroke-linecap="round" stroke-linejoin="round"
